 ...
 *1-----*snsr_type_name --> component/isp/common/sensor_list.c
...
CVI_S32 SAMPLE_COMM_SNS_GetSize(SAMPLE_SNS_TYPE_E enMode, PIC_SIZE_E *penSize)
{
	...
	case SMS_SC200AI_1L_MIPI_2M_30FPS_10BIT:
	...
	case SONY_IMX335_MIPI_4M_1600P_30FPS_10BIT_WDR2TO1:
		*penSize = PIC_2560x1600;
		break;
	case GCORE_GC05A2_MIPI_5M_30FPS_10BIT:
		*penSize = PIC_2560x1920;
		break;
...
CVI_S32 SAMPLE_COMM_SNS_GetDevAttr(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S *pstViDevAttr)
{
	...
	case CHIPUP_XS9922B_MODE_720P_2CH_8BIT:
		...
		break;
	case CHIPUP_XS9922B_MODE_720P_3CH_8BIT:
		pstViDevAttr->enWorkMode = VI_WORK_MODE_3Multiplex;
		break;
	case PIXELPLUS_PR2100_2M_4CH_25FPS_8BIT:
...
CVI_VOID *SAMPLE_COMM_SNS_GetSnsObj(SAMPLE_SNS_TYPE_E enSnsType)
{
	...
	case BYD_BF2253L_MIPI_1200P_30FPS_10BIT:
		...
		break;
#endif
#if defined(SENSOR_CHIPUP_XS9922B)
	case CHIPUP_XS9922B_MODE_720P_1CH_8BIT:
	case CHIPUP_XS9922B_MODE_720P_2CH_8BIT:
	case CHIPUP_XS9922B_MODE_720P_3CH_8BIT:
		pSnsObj = &stSnsXS9922B_Obj;
		break;
#endif
#if defined(SENSOR_CVSENS_CV2002)
	case CVSENS_CV2002_MIPI_2M_1080P_30FPS_10BIT:
	case CVSENS_CV2002_MIPI_2M_1080P_30FPS_WDR2TO1:
		return &stSnsCV2002_Obj;
#endif
#if defined(SENSOR_CVSENS_CV2003)
	case CVSENS_CV2003_MIPI_2M_1080P_30FPS_10BIT:
...
#endif
#if defined(SENSOR_CVSENS_CV2003_1L_SLAVE1)
	case CVSENS_CV2003_1L_SLAVE1_MIPI_2M_1080P_30FPS_10BIT:
...
#endif
#if defined(SENSOR_CVSENS_CV4002)
	case CVSENS_CV4002_MIPI_4M_1440P_25FPS_10BIT:
	case CVSENS_CV4002_MIPI_1M_720P_30FPS_10BIT:
...
#endif
#if defined(SENSOR_GCORE_GC0308)
	case GCORE_GC0308_MIPI_480P_30FPS_8BIT:
...
#endif
#if defined(SENSOR_GCORE_GC05A2)
	case GCORE_GC05A2_MIPI_5M_30FPS_10BIT:
		return &stSnsGc05a2_Obj;
#endif
...
#if defined(SENSOR_GCORE_GC1084_SLAVE1)
	case GCORE_GC1084_SLAVE1_MIPI_1M_30FPS_10BIT:
		return &stSnsGc1084_Slave1_Obj;
#endif
#if defined(SENSOR_GCORE_GC1084_SLAVE2)
	case GCORE_GC1084_SLAVE2_MIPI_1M_30FPS_10BIT:
	...
	case PICO640_THERMAL_479P:
		...
		break;
#endif
#if defined(SENSOR_PIXELPLUS_PR2000)
	case PIXELPLUS_PR2000_2M_30FPS_8BIT:
		pSnsObj = &stSnsPR2000_Obj;
		break;
#endif
	...
	case SMS_SC035HGS_1L_MIPI_480P_120FPS_10BIT:
		...
		break;
#endif
#if defined(SENSOR_SMS_SC132GS)
	case SMS_SC132GS_MIPI_1080P_60FPS_10BIT:
		pSnsObj = &stSnsSC132GS_Obj;
		break;
#endif

#if defined(SENSOR_SMS_SC132GS_SLAVE)
	case SMS_SC132GS_SLAVE_MIPI_1080P_60FPS_10BIT:
		pSnsObj = &stSnsSC132GS_SLAVE_Obj;
		break;
#endif
	...
	case SMS_SC200AI_MIPI_2M_30FPS_10BIT_WDR2TO1:
		...
		break;
#endif
#if defined(SENSOR_SMS_SC200AI_1L)
	case SMS_SC200AI_1L_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsSC200AI_1L_Obj;
		break;
#endif
#if defined(SENSOR_SMS_SC230AI_2L)
	case SMS_SC230AI_2L_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsSC230AI_2L_Obj;
		break;
#endif
#if defined(SENSOR_SMS_SC230AI_2L_SLAVE)
	case SMS_SC230AI_2L_SLAVE_MIPI_2M_30FPS_10BIT:
...
#if defined(SENSOR_SOI_F53)
	case SOI_F53_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsF53_Obj;
		break;
#endif
	...
	case SOI_Q03P_MIPI_3M_30FPS_10BIT:
		...
		break;
#endif
#if defined(SENSOR_SOI_F352)
	case SOI_F352_MIPI_2M_30FPS_10BIT:
	case SOI_F352_MIPI_2M_30FPS_10BIT_WDR2TO1:
		pSnsObj = &stSnsF352_Obj;
		break;
#endif
#if defined(SENSOR_SOI_K306)
	case SOI_K306_MIPI_4M_25FPS_10BIT:
		return &stSnsK306_Obj;
#endif
