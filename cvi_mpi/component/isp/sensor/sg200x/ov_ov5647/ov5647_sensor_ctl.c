...
/* 720P60, 2x2 binned/cropped output. Timing is HTS 1750, VTS 800,
 * approximately 84 MHz pixel clock: 84 MHz / (1750 * 800) = 60 fps.
 * The mode values are cross-checked against the public OV5647 720p table;
 * validate this module's MIPI/ISP lock and image quality on hardware before
 * making the mode the default.
 */
static void ov5647_linear_720p60_init(VI_PIPE ViPipe)
{
	ov5647_write_register(ViPipe, 0x0100, 0x00);
	ov5647_write_register(ViPipe, 0x0103, 0x01);
	ov5647_write_register(ViPipe, 0x3035, 0x21);
	ov5647_write_register(ViPipe, 0x3036, 0x69);
	ov5647_write_register(ViPipe, 0x303c, 0x12);
	ov5647_write_register(ViPipe, 0x3821, 0x07);
	ov5647_write_register(ViPipe, 0x3820, 0x41);
	ov5647_write_register(ViPipe, 0x370c, 0x03);
	ov5647_write_register(ViPipe, 0x3612, 0x49);
	...
	ov5647_write_register(ViPipe, 0x3c01, 0x80);
	ov5647_write_register(ViPipe, 0x3b07, 0x0c);
	ov5647_write_register(ViPipe, 0x380c, 0x06);
	ov5647_write_register(ViPipe, 0x380d, 0xd6);
	ov5647_write_register(ViPipe, 0x380e, 0x03);
	ov5647_write_register(ViPipe, 0x380f, 0x20);
	ov5647_write_register(ViPipe, 0x3814, 0x31);
	ov5647_write_register(ViPipe, 0x3815, 0x31);
	ov5647_write_register(ViPipe, 0x3708, 0x22);
	...
	ov5647_write_register(ViPipe, 0x3803, 0xf8);
