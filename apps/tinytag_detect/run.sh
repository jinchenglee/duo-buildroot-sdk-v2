#!/bin/sh
# TinyTag detector launcher -- installed to /usr/local/bin/run_tinytag.sh on the
# board by apps/tinytag_detect/build.sh.
#
...
TINYTAG_MODEL="${TINYTAG_MODEL:-/mnt/cvimodel/tinytag-v40c.int8.cvimodel}"
...
TINYTAG_BIN="${TINYTAG_BIN:-/usr/local/bin/tinytag_detect}"
TINYTAG_GOLDEN="${TINYTAG_GOLDEN:-/mnt/cvimodel/tinytag-v40c.ttgold}"
